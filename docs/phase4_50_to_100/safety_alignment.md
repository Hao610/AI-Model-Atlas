...
[English] | [中文 (safety_alignment_zh.md)](safety_alignment_zh.md)
...
Now that you understand safety boundaries, let's learn how to take your model and launch it on a cloud server for public use in [Cloud Deployment](deployment.md).
