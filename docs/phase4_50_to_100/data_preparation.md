...
[English] | [中文 (data_preparation_zh.md)](data_preparation_zh.md)
...
Now that your training data is ready, you can feed it into your model in [Why Fine-Tune?](finetuning.md).
