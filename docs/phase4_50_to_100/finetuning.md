...
[English] | [中文 (finetuning_zh.md)](finetuning_zh.md)
...
Now that you know why we fine-tune, let's learn about the most popular and cost-effective technique to do it in [LoRA Explained](lora_explained.md).
