...
Now that you know how to choose your hardware, let's explore why models refuse to answer certain prompts and how safety systems are built in [Safety & Alignment](30_safety_alignment.md).
