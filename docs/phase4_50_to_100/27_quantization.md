...
[English] | [中文 (27_quantization_zh.md)](27_quantization_zh.md)
...
Now that you know how to compress models to fit on consumer hardware, let's explore how to select the right GPU for your budget and goals in [GPU Selection Guide](28_gpu_selection.md).
