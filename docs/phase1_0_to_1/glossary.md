...
[English] | [中文 (glossary_zh.md)](glossary_zh.md)
...
Next, let's step into **Phase 2 (1 to 10)** and learn how models scale in [LLM Landscape](../phase2_1_to_10/llm_landscape.md).
