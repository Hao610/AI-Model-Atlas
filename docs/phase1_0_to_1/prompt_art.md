...
[English] | [中文 (prompt_art_zh.md)](prompt_art_zh.md)
...
Now that you can talk to AI like a pro, let's understand the rules of the playground in [Open Source Licenses](licenses.md).
