...
[English] | [中文 (licenses_zh.md)](licenses_zh.md)
...
Now that you know the legal playground, let's look at the actual apps you can play with today in the [AI Tools Guide](ai_tools.md).
