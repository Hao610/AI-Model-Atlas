...
[English] | [中文 (06_huggingface_guide_zh.md)](06_huggingface_guide_zh.md)
...
Now that you can navigate the open-source registry, let's explore multimodal models that process images, audio, and video in [Multimodal AI](../phase2_1_to_10/10_multimodal_models.md).
