...
[[English] (rag_system_design.md)](rag_system_design.md) | [中文]
...
掌握了 RAG 架构设计，接下来让我们去了解大模型服务在线上运行时，显存优化与高并发推理的幕后逻辑：进入 [推理优化与服务](../phase4_50_to_100/inference_optimization_zh.md)。
