...
[English] | [中文 (agent_frameworks_zh.md)](agent_frameworks_zh.md)
...
Now that you know how to build teams, let's explore how computers understand the meaning of human text behind the scenes in [Embeddings Deep Dive](embeddings.md).
