...
[English] | [中文 (cost_and_tokens_zh.md)](cost_and_tokens_zh.md)
...
Now that you can calculate your costs, let's learn how to prep and clean your training data before starting a fine-tuning run in [Data Preparation](../phase4_50_to_100/data_preparation.md).
