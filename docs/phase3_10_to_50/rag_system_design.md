...
[English] | [中文 (rag_system_design_zh.md)](rag_system_design_zh.md)
...
Now that you know how to architect search, let's explore inference optimizations to make the model run faster on your GPU in [Inference Optimization](../phase4_50_to_100/inference_optimization.md).
