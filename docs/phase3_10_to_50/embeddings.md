...
[English] | [中文 (embeddings_zh.md)](embeddings_zh.md)
...
Now that you know how semantic search operates, let's learn how we scientifically test and evaluate these models in [Model Evaluation](evaluation.md).
