...
[English] | [中文 (ai_workflows_zh.md)](ai_workflows_zh.md)
...
Now that you understand the architectural flow, let's explore real-world templates of this layout in [Real-World Use Cases](use_cases.md).
