...
[English] | [中文 (12_vector_db_zh.md)](12_vector_db_zh.md)
...
Now that you know where vectors are stored, let's look at the flow of data in a complete system in [AI Workflows](13_ai_workflows.md).
