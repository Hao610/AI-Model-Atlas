...
[English] | [中文 (rag_intro_zh.md)](rag_intro_zh.md)
...
Now that you know the theory of RAG, let's look at where we store these mathematical text coordinates in [Vector Databases](vector_db.md).
