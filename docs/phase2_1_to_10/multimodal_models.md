...
[English] | [中文 (multimodal_models_zh.md)](multimodal_models_zh.md)
...
Now that you understand how AI processes media, let's explore how we budget and calculate the token costs of these systems in [Token Economics & Cost Estimation](../phase3_10_to_50/cost_and_tokens.md).
