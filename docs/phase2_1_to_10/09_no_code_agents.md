...
[English] | [中文 (09_no_code_agents_zh.md)](09_no_code_agents_zh.md)
...
No-code platforms handle the indexing automatically, but what happens under the hood when the agent reads your files? Let's discover in [RAG Introduction](11_rag_intro.md).
