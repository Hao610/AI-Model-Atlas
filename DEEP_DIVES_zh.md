...
| 章节 | 描述 | English Guide | 中文指南 |
| :--- | :--- | :--- | :--- |
| **03. Embedding 到底是什么？** | 从词汇表到多维物理空间：文本语义的坐标化表示。 | [03_embedding.md](docs/appendix_deep_dives/03_embedding.md) | [03_embedding_zh.md](docs/appendix_deep_dives/03_embedding_zh.md) |
| **04. 向量数据库如何理解语义？** | 告别字面匹配：最近邻搜索算法与 HNSW 索引的导航机制。 | [04_vector_db.md](docs/appendix_deep_dives/04_vector_db.md) | [04_vector_db_zh.md](docs/appendix_deep_dives/04_vector_db_zh.md) |
| **05. RAG 为什么有效？** | 开卷考试 vs 闭卷考试：打通静态训练参数与动态实时检索的桥梁。 | [05_rag_principles.md](docs/appendix_deep_dives/05_rag_principles.md) | [05_rag_principles_zh.md](docs/appendix_deep_dives/05_rag_principles_zh.md) |
